...
namespace WebApplication6.Controllers
{
    public class DoctorsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description,HospitalId")] Doctor doctor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description,HospitalId")] Doctor doctor)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult addPatient(DoctorPatient model)
        {
            ...
            db.SaveChanges();
            return View("Index",db.Doctors.ToArray());
        }
